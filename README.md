...
MacSpoofer is build using Tkinter as the GUI toolkit and py2app in order to turn the script into a MAC OS X application. Also, we looked into feross [SpoofMAC](https://github.com/feross/SpoofMAC) to get ideas about what the best way to build this is.
